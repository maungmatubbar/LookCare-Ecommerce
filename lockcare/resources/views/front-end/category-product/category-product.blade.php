                        ...
                        <div id="shop-all" class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4 product-item filter-best">
                                <div class="product-img">
                                    <img src="{{asset($categoryProduct->product_image)}}" alt="product">
                                ...
                                <div class="product-bio">
                                    <h4>
                                        <a href="{{route('product-details',['id'=>$categoryProduct->id,'categoryId'=>$categoryProduct->category_id])}}">{{$categoryProduct->product_name}}</a>
                                    </h4>
                                    <p class="product-price">BDT {{$categoryProduct->product_price}}</p>
                                </div>
                                <!-- .product-bio end -->
                            </div>
                            @endforeach
